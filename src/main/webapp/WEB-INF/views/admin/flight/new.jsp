...
<div class="container" style="width: 70%">
	<form:form action="new" method="post" modelAttribute="flight">
	   <fieldset>
	       <legend><spring:message code="msg.label.flight.addNew" /></legend>
	 	...
	 	<div class="form-group" >           
	       ...
	       <div class="form-group" >
	       		<label for="destination"><spring:message code="msg.label.flight.destination" /></label>
	       ...
	       <div style="float:right;">
	            ...
	            <button id="btnNew" type="submit" name="edit" class="btn btn-outline-success"><spring:message code="msg.label.flight.btnNew" /></button>
	        </div>
	    </fieldset>
	</form:form>
</div>
