...
public class FlightController {
	...
	@Autowired
	private FlightScheduleValidator flightScheduleValidator;
	...
	@RequestMapping(value={"/admin/flight", "/admin/flight/","/admin/flight/index"}, method = RequestMethod.GET)
	...
	@RequestMapping(value = "/admin/flight/new", method = RequestMethod.GET)
	public String newFlightForm(@ModelAttribute("flight")Flight flight, Model model){
		
		return "admin/flight/new";
	}

	@RequestMapping(value = "/admin/flight/new", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/admin/flight/edit/{id}", method = RequestMethod.GET)
    public String get(@PathVariable long id, Model model) {
        model.addAttribute("flight", this.flightService.findOne(id));
        return "admin/flight/edit";
    }
	
	@RequestMapping(value= "/admin/flight/edit/{id}", method = RequestMethod.POST)
